...
- [Sunglasses - Runtime trust scanner that checks MCP tool descriptions, skills, and prompts against 1,089 patterns in 65 attack categories (tool poisoning, discovery file poisoning, tool metadata smuggling)](https://github.com/sunglasses-dev/sunglasses)
